    ...
    <div className="flex justify-between h-[70vh] max-w-7xl mx-auto">
        <div className="w-full h-full pt-20 xl:pt-36 pl-3">
            ...
            <div className="flex flex-col items-start gap-3 mt-5 md:flex-row">
                <Link to='/products'><button className="text-sm bg-neutral-900 px-5 py-3 rounded-md hover:bg-neutral-700 hover:shadow-sm hover:shadow-black/30 transition-all duration-300 ease-in-out text-neutral-100 font-light flex items-center gap-1">Shop Now <span><IconArrowRight size={17}/></span></button></Link>
