...
export const Testimonials = () => {
  return (
    <div className="bg-neutral-100/80 py-10">
        <div className="bg-white xl:max-w-7xl xl:mx-auto mx-5 md:py-20 py-10 overflow-hidden ">
           <div className="flex flex-col items-center py-10">
             <h1 className="md:text-4xl text-3xl font-semibold">What Our Customers Say</h1>
             <p className="text-neutral-500 mt-5 md:text-xl text-center  w-[90%] mx-auto">Don't just take our word for it - hear from our satisfied customers</p>
           </div>

           <div className="inline-flex gap-4 mask-b-from-60% mask-l-from-95% mask-r-from-95%">
             <TestimonialCard
        name="Ayesha Khan"
...
function TestimonialCard ({name, address, testimonial}: TestimonialCardProps) {
    return (
        <div className="bg-linear-to-b from-neutral-100 to-white shadow-[0px_-1px_1px_rgba(0,0,0,0.3)] p-5 w-[300px] h-[200px] rounded-xl overflow-hidden">
