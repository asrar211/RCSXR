  ...
  return (
    <div className="pt-17 flex items-center max-[64rem]:h-screen w-full">
        ...
        <div className="flex flex-col max-w-3xl mx-auto">
          <div>
            <h1 className="text-3xl font-bold max-[64rem]:text-center">Sign In</h1>
            <p className="text-neutral-500 mt-3 font-light text-[14px] max-[64rem]:text-center">Enter your credentials to access your account</p>
          </div>
          <div className=" rounded-xl bg-white p-4 shadow-md max-[55rem]:w-[90vw] w-[450px] mt-5">
            ...
            <div className="relative flex justify-center items-center mt-5">
              <button className="bg-neutral-800 shadow-sm text-neutral-50 py-2 w-full rounded-lg text-sm hover:bg-neutral-700 transition-all duration-300 ease-in-out hover:shadow-lg">Sign in</button>
            <hr className="w-full h-px text-neutral-200 mt-5 absolute -bottom-10 left-0"/>
            </div>
            <div className="mt-15 text-center">
              <p className="text-neutral-500 text-sm">Don't have an account? <span className="text-neutral-800 cursor-pointer"><Link to='/auth/signup'>Sign up</Link></span></p>
            </div>
          </div>
        </div>
    </div>
