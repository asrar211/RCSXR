import { IconShoppingCart, IconStarFilled, IconHeart, IconHeartFilled } from "@tabler/icons-react";
...
export const Products = () => {
  const products = [
    {
      ...
      price: 19.99,
      discount: 10,
      finalPrice: (19.99 - 19.99 * 0.1).toFixed(2),
    ...
    },
    {
      ...
      price: 29.99,
      discount: 15,
      finalPrice: (29.99 - 29.99 * 0.15).toFixed(2),
    ...
    },
    {
      ...
      price: 14.99,
      discount: 5,
      finalPrice: (14.99 - 14.99 * 0.05).toFixed(2),
    ...
    },
    {
      ...
      price: 39.99,
      discount: 20,
      finalPrice: (39.99 - 39.99 * 0.2).toFixed(2),
    ...
    },
    {
      ...
      price: 49.99,
      discount: 25,
      finalPrice: (49.99 - 49.99 * 0.25).toFixed(2),
    ...
    },
    {
      ...
      price: 24.99,
      discount: 10,
      finalPrice: (24.99 - 24.99 * 0.1).toFixed(2),
    ...
    },
    {
      ...
      price: 27.99,
      discount: 12,
      finalPrice: (27.99 - 27.99 * 0.12).toFixed(2),
    ...
    },
    {
      ...
      price: 9.99,
      discount: 5,
      finalPrice: (9.99 - 9.99 * 0.05).toFixed(2),
    ...
    },
    {
      ...
      price: 22.99,
      discount: 8,
      finalPrice: (22.99 - 22.99 * 0.08).toFixed(2),
    ...
    },
    {
      ...
      price: 12.99,
      discount: 10,
      finalPrice: (12.99 - 12.99 * 0.1).toFixed(2),
  ...
  return (
    <div className="pt-20 mx-5 mt-10 xl:mr-20">
      <div className="flex xl:flex-row justify-between xl:items-center flex-col mx-5">
        ...
        <div className="flex flex-wrap gap-2 mt-5 xl:mt-0">
          {["All", "Clothing", "Footwear", "Toys", "Accessories", "Winter Wear"].map(
            (category, index) => (
              <button
                key={index}
                className="border border-neutral-200 shadow-sm text-sm rounded-full px-3 py-1 hover:bg-neutral-100 transition-all duration-300"
              >
                {category}
              </button>
            )
